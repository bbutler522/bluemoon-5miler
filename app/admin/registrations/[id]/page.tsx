...
const statusStyles: Record<string, { icon: typeof CheckCircle2; color: string; bg: string; label: string }> = {
  ...
  refunded: { icon: XCircle, color: 'text-stardust/100', bg: 'bg-stardust/5 border-stardust/10', label: 'Refunded' },
};
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-xs text-stardust/40">
        ...
        <span>/</span>
        <span className="text-stardust/100">{reg.first_name} {reg.last_name}</span>
      </div>
        ...
        <div className="card p-6 space-y-4">
          ...
          <div>
            ...
            {editMode ? (
              ...
              <p className="text-sm text-stardust/100">{reg.phone || '—'}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-sm text-stardust/100">{reg.gender || '—'}</p>
            </div>
            <div>
              <label className="label-field">Date of Birth</label>
              <p className="text-sm text-stardust/100">{reg.date_of_birth || '—'}</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              {editMode ? (
                ...
                <p className="text-sm text-stardust/100">{reg.shirt_size || '—'}</p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {editMode ? (
                ...
                <p className="text-sm text-stardust/100">{reg.emergency_contact_name || '—'}</p>
              )}
            </div>
            <div>
              <label className="label-field">Phone</label>
              {editMode ? (
                ...
                <p className="text-sm text-stardust/100">{reg.emergency_contact_phone || '—'}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="card p-6 space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-stardust/100">Registered</p>
            ...
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-stardust/20" />
              <div>
                <p className="text-xs text-stardust/100">Last Updated</p>
                <p className="text-xs text-stardust/30">
            ...
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-stardust/20" />
              <div>
                <p className="text-xs text-stardust/100">Registration ID</p>
