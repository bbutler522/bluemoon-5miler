        ...
        {reg ? (
          <div className="space-y-6">
                ...
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    ...
                    <div className="pb-4">
                      ...
                      <p className="text-xs text-stardust/50 mt-1 leading-relaxed">
                        {item.desc}
                      </p>
                    </div>
                  </div>
            ...
            >
              ...
              <ChevronRight
                size={16}
                className="text-stardust/20 group-hover:text-stardust/50 transition-colors"
              />
            </Link>
          </div>
        ) : (
          ...
          <div className="card p-10 text-center">
            ...
            <p className="text-sm text-stardust/50 mb-6">
